...
const GITHUB_REPO_NAME  = 'magecache';
...
function callGitHubApi($uri, $method = 'GET', $postData = null)  
{
    ...
    $options = array(
        ...
        CURLOPT_USERAGENT      => 'MageCache Installer'
    );
...
{  
    $outFile = dirname(__FILE__) . '/var/' . GITHUB_REPO_NAME . '.tar.gz';

    echo "Start downloading " . GITHUB_REPO_NAME . " archive at $downloadUri into $outFile ...\n";
