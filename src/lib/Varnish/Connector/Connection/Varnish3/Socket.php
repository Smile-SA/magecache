...
*/
class Varnish_Connector_Connection_Varnish3_Socket extends Varnish_Connector_Connection_Socket
{
    /**
    ...
    {
        $this->_put('ban obj.http.'.$header.' ~ '.$tag, true);
    }
    ...
    {
        $this->_put('ban.url '.$pattern, true);
    }
}
